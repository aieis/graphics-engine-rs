...
void main() {
    ...
    glyph_position = vec2((float(c_pos_x) / chars_per_row) - 0.5, (float(c_pos_y) / chars_per_col) - 0.5);
    ...
    // vec2 pos =  T.Position.xy + glyph_position + vec2(p_x_offset, p_y_offset) * cw_scale;
